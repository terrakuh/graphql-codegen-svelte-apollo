...
export type GetMessagesQuery = {
	__typename?: "Query";
	messages?: Array<{ __typename?: "Message"; id: number; value: string; tstamp?: string | null }> | null;
};
...
export type PostMessageMutation = {
	__typename?: "Mutation";
	post?: { __typename?: "Message"; id: number; value: string } | null;
};

export const GetMessagesDoc = gql`
	query GetMessages {
		messages {
			id
			value
...
export const PostMessageDoc = gql`
	mutation PostMessage($msg: String!) {
		post(msg: $msg) {
			id
			value
		}
...
export const GetMessages = (
	client: ApolloClient,
	options: Omit<
		ApolloClient.WatchQueryOptions<GetMessagesQuery, GetMessagesQueryVariables>,
		"query" | "returnPartialData"
	> & { immediate?: boolean },
) => {
	...
	const result = readable<ObservableQuery.Result<GetMessagesQuery | undefined, "empty" | "complete">>(
		{ ...currentResult },
		(set) => {
